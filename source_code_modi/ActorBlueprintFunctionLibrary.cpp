    ...
    FActorDefinition &Definition)
{
  ...
  // Number of  lidar cloud points.
  FActorVariation Num_rs;
  Num_rs.Id = TEXT("Num_rs");
  Num_rs.Type = EActorAttributeType::Int;
  Num_rs.RecommendedValues = { TEXT("78750") };
  ...
  else if (Id == "ray_cast_rs_semantic"){
    Definition.Variations.Append({
      Channels,
      Range,
      PointsPerSecond,
