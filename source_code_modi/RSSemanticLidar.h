...
//*****************************
#include "RSSemanticLidar.generated.h"

/// A ray-cast based Lidar sensor.
UCLASS()
class CARLA_API ARSSemanticLidar: public ASensor
{
  GENERATED_BODY()
...
public:
  ...
  ARSSemanticLidar(const FObjectInitializer &ObjectInitializer);
...
protected:
  ...
  TArray<float> LaserAngles;     //vectical angle
  TArray<float> LaserAngles_h;   //horizontal angle
  TArray<float> Time_sim;   //horizontal angle
